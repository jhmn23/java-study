...
class Person {
	...
	public boolean equals(Object other) {
		// Object클래스의 equals를 오버라이드해서 Person클래스의 이름으로 비교하도록 수정
		...
		if(this.name == null) return false; // this객체의 이름이 널값이면 false
		Person p = (Person)other; //다운캐스팅 타입변환
		if(p.name == null) return false; // other객체의 이름이 널값이면 false
...
public class App {
	public static void main(String[] args) {
		...
		System.out.println(p1.equals(p2)); // equals 메소드를 다시 작성하여 이름값으로 비교
