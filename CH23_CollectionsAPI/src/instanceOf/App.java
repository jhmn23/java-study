...
//크리쳐 클래스는 시리얼인터페이스를 구현하여 디폴트 id를 만들었음
class Creature implements Serializable {
	private static final long serialVersionUID = 1L;	
}
//캣 클래스는 크리처클래스를 상속하여 디폴트 id를 만들었음
...
public class App {
	public static void main(String[] args) {
		...
		System.out.println(c2 instanceof Object); //Object는 최상위 클래스이므로
		
		System.out.println(c2 instanceof Serializable); //Serializable 인터페이스 구현했기 때문에 true
		
		System.out.println(c2 instanceof Creature); //크리처 클래스의 객체임
